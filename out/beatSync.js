...
class BeatSync {
    constructor(cdp) {
        ...
        this.statusItem = vscode.window.createStatusBarItem(vscode.StatusBarAlignment.Right, 999);
    ...
    onBeat(intensity) {
        ...
        this.clearTimer = setTimeout(() => this.clearPulse(), PULSE_DURATION_MS);
    }
    applyPulse(intensity) {
        // ── Status bar flash ────────────────────────────────────────────────────
...
exports.BeatSync = BeatSync;
//# sourceMappingURL=beatSync.js.map